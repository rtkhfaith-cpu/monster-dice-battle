...
const DEFS = [
  ...
  { id: 'nugget_dragon', name: 'Nugget Dragon', rarity: 'common', role: 'brawler', element: 'fire', elements: ['fire', 'fire'], faction: 'fast_food', colorIdx: 2, species: 14 },
  { id: 'bubble_tea_hydra', name: 'Bubble Tea Hydra', rarity: 'legendary', role: 'mage', element: 'water', elements: ['water', 'water'], faction: 'boba', colorIdx: 5, species: 15 },
  { id: 'lagzilla', name: 'Lagzilla', rarity: 'epic', role: 'debuffer', element: 'metal', elements: ['metal', 'earth'], faction: 'noise_tech', colorIdx: 6, species: 16 },
  ...
  { id: 'algorithm_angel', name: 'Algorithm Angel', rarity: 'mythic', role: 'mage', element: 'metal', elements: ['metal', 'water'], faction: 'core_feed', colorIdx: 10, species: 21 },
  ...
  { id: 'pizza_meteor', name: 'Pizza Meteor', rarity: 'common', role: 'brawler', element: 'fire', elements: ['fire', 'fire'], faction: 'fast_food', colorIdx: 2, species: 23 },
  { id: 'cloud_catfish', name: 'Cloud Catfish', rarity: 'rare', role: 'mage', element: 'water', elements: ['water', 'water'], faction: 'sky', colorIdx: 5, species: 24 },
  { id: 'keyboard_golem', name: 'Keyboard Golem', rarity: 'epic', role: 'tank', element: 'metal', elements: ['metal', 'metal'], faction: 'noise_tech', colorIdx: 7, species: 25 },
  { id: 'noodle_basilisk', name: 'Noodle Basilisk', rarity: 'legendary', role: 'mage', element: 'fire', elements: ['fire', 'wood'], faction: 'food', colorIdx: 3, species: 26 },
  { id: 'sneaker_shark', name: 'Sneaker Shark', rarity: 'rare', role: 'speedster', element: 'water', elements: ['water', 'metal'], faction: 'urban', colorIdx: 6, species: 27 },
  { id: 'battery_bat', name: 'Battery Bat', rarity: 'common', role: 'trickster', element: 'metal', elements: ['metal', 'metal'], faction: 'noise_tech', colorIdx: 8, species: 28 },
  ...
  { id: 'microwave_mantis', name: 'Microwave Mantis', rarity: 'legendary', role: 'brawler', element: 'fire', elements: ['fire', 'metal'], faction: 'kitchen', colorIdx: 2, species: 31 },
  ...
  { id: 'bubblewrap_blob', name: 'Bubblewrap Blob', rarity: 'common', role: 'tank', element: 'water', elements: ['water', 'metal'], faction: 'plastic', colorIdx: 6, species: 33 },
  { id: 'drone_goblin', name: 'Drone Goblin', rarity: 'rare', role: 'speedster', element: 'metal', elements: ['metal', 'water'], faction: 'noise_tech', colorIdx: 9, species: 34 },
  { id: 'blackout_bunny', name: 'Blackout Bunny', rarity: 'epic', role: 'debuffer', element: 'metal', elements: ['metal', 'earth'], faction: 'blackout', colorIdx: 7, species: 35 },
  { id: 'core_feed_beast', name: 'Core Feed Beast', rarity: 'mythic', role: 'mage', element: 'metal', elements: ['metal', 'metal'], faction: 'core_feed', colorIdx: 10, species: 36 },
];

function buildTemplate(def) {
  const baseStats = { ...BASE_BY_RARITY[def.rarity] };
  return {
    id: def.id,
    name: def.name,
    rarity: def.rarity,
    ...
    faction: def.faction,
    description: `Ladder-exclusive · ${def.faction}`,
    baseStats,
