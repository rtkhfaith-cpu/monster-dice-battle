...
export const RUSH_PATTERN_LIBRARY = [
  ...
  },
  {
    ...
    tags: ['top'],
    items: [
      { type: 'top_barrier', x: 24, y: 'ceiling', width: 50, height: 64 },
      { type: 'top_barrier', x: 170, y: 'ceiling', width: 54, height: 68 },
    ],
  },
  {
    id: 'med_ceiling_spike_pair',
    tier: 'medium',
    minScrollPx: 900,
    width: 260,
    recovery: 185,
    ...
    tags: ['top'],
    items: [
      { type: 'top_spike', x: 40, y: 'ceiling', width: 38, height: 44 },
      { type: 'top_spike', x: 170, y: 'ceiling', width: 38, height: 44 },
    ],
  },
  {
    id: 'med_ceiling_ground_squeeze',
    tier: 'medium',
    minScrollPx: 1100,
    width: 300,
    recovery: 200,
    ...
    tags: ['top', 'ground'],
    items: [
      { type: 'top_barrier', x: 30, y: 'ceiling', width: 58, height: 76 },
      { type: 'low_block', x: 180, y: 'ground', width: 44, height: 36 },
    ],
  },
  {
    id: 'hard_ceiling_gap',
    ...
    tags: ['top', 'gap'],
    items: [
      { type: 'top_barrier', x: 20, y: 'ceiling', width: 120, height: 82 },
      { type: 'gap', x: 160, width: 110 },
    ],
  },
];
