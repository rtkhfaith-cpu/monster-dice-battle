...
const styles = StyleSheet.create({
  root: { flex: 1, minHeight: 0, paddingHorizontal: 12, paddingTop: 10, backgroundColor: '#050b16' },
  topBar: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  back: { color: '#ffe08a', fontWeight: '900', fontSize: 14, minWidth: 56 },
  title: { color: '#fff8dd', fontWeight: '900', fontSize: 18, textShadowColor: '#000', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 2 },
  subtitle: { color: '#f8fbff', fontSize: 12, fontWeight: '900', textAlign: 'center', marginTop: 6, lineHeight: 17 },
  ...
  slotActive: { borderColor: '#fcd34d', backgroundColor: 'rgba(55,36,94,0.98)' },
  slotPos: { color: '#fcd34d', fontWeight: '900', fontSize: 16 },
  slotTitle: { color: '#fff4cf', fontWeight: '900', fontSize: 10, textAlign: 'center' },
  slotSub: { color: '#dbeafe', fontWeight: '900', fontSize: 8, marginBottom: 4 },
  slotMonName: { color: '#ffffff', fontWeight: '900', fontSize: 9, marginTop: 2, maxWidth: 80, textAlign: 'center' },
  ...
  slotEmpty: { color: '#cbd5e1', fontWeight: '900', fontSize: 9, marginTop: 16, textAlign: 'center' },
  powerRow: { marginTop: 10, alignItems: 'center', backgroundColor: 'rgba(2,8,23,0.94)', borderRadius: 10, borderWidth: 1, borderColor: 'rgba(255,224,138,0.25)', paddingVertical: 8, paddingHorizontal: 10 },
  powerTxt: { color: '#ffffff', fontWeight: '900', fontSize: 12 },
  ...
  monsterRowPlaced: { borderColor: '#86efac', backgroundColor: 'rgba(18,53,40,0.92)' },
  monsterInfo: { flex: 1, minWidth: 0 },
  monsterName: { color: '#fff4cf', fontWeight: '900', fontSize: 13 },
  monsterMeta: { color: '#e0f2fe', fontWeight: '900', fontSize: 10, marginTop: 2 },
