...
import { DEFAULT_ST, RigFace, RigGlowCore, RigPanel, ShadeBody } from '../../../art/monsters/monsterRig';
...
export default function BodyTablet({ stroke, m, mood, eyeWhite, pupil, palette, ST = DEFAULT_ST }) {
  ...
  return (
    <ShadeBody gradId={gid} palette={p} highlight={{ cx: 88, cy: 96, rx: 30, ry: 44 }}>
      <Circle cx={100} cy={150} r={30} fill={p.glow} opacity={0.22} />
      <Ellipse cx={100} cy={170} rx={24} ry={7} fill={p.dark} opacity={0.3} />
      ...
      <Ellipse cx={100} cy={182} rx={10} ry={5} fill={p.dark} stroke={stroke} strokeWidth={2} />
